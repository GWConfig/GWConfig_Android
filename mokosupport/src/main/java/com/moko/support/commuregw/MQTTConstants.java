...
public class MQTTConstants {
    ...
    public static final int CONFIG_MSG_ID_BLE_BXP_BUTTON_GET_SOS_ALARM = 1177;
    public static final int CONFIG_MSG_ID_BLE_BXP_BUTTON_SET_SOS_ALARM = 1179;
    public static final int CONFIG_MSG_ID_BLE_BXP_BUTTON_GET_LED_BUZZER_TEST_PARAMS = 1181;
    public static final int CONFIG_MSG_ID_BLE_BXP_BUTTON_SET_LED_BUZZER_TEST_PARAMS = 1183;
    public static final int CONFIG_MSG_ID_BLE_BXP_BUTTON_GET_DISMISS_SOS_ALARM = 1185;
    public static final int CONFIG_MSG_ID_BLE_BXP_BUTTON_SET_DISMISS_SOS_ALARM = 1187;
    public static final int CONFIG_MSG_ID_BLE_BXP_BUTTON_GET_BTN_PRESS_EFFECTIVE_INTERVAL = 1189;
    public static final int CONFIG_MSG_ID_BLE_BXP_BUTTON_SET_BTN_PRESS_EFFECTIVE_INTERVAL = 1191;
    ...
    public static final int NOTIFY_MSG_ID_BLE_BXP_BUTTON_GET_SOS_ALARM = 3178;
    public static final int NOTIFY_MSG_ID_BLE_BXP_BUTTON_SET_SOS_ALARM = 3180;
    public static final int NOTIFY_MSG_ID_BLE_BXP_BUTTON_GET_LED_BUZZER_TEST_PARAMS = 3182;
    public static final int NOTIFY_MSG_ID_BLE_BXP_BUTTON_SET_LED_BUZZER_TEST_PARAMS = 3184;
    public static final int NOTIFY_MSG_ID_BLE_BXP_BUTTON_GET_DISMISS_SOS_ALARM = 3186;
    public static final int NOTIFY_MSG_ID_BLE_BXP_BUTTON_SET_DISMISS_SOS_ALARM = 3188;
    public static final int NOTIFY_MSG_ID_BLE_BXP_BUTTON_GET_BTN_PRESS_EFFECTIVE_INTERVAL = 3190;
    public static final int NOTIFY_MSG_ID_BLE_BXP_BUTTON_SET_BTN_PRESS_EFFECTIVE_INTERVAL = 3192;

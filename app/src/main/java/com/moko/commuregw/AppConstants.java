...
public class AppConstants {
    ...
    public static final String ACTION_DELETE_DEVICE = "com.moko.commuregw.action.ACTION_DELETE_DEVICE";
    public static final String ACTION_DEVICE_STATE = "com.moko.commuregw.action.ACTION_DEVICE_STATE";
    // sp
    ...
    public static final String EXTRA_KEY_GATEWAY_CONFIG = "EXTRA_KEY_GATEWAY_CONFIG";
    // request_code
